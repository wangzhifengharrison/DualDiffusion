...
import os
# from utils import forward_kinematics_for_bighand
...
def expmap2xyz_torch(expmap):
    ...
    :return: N*32*3
    """
    parent, offset, rotInd, expmapInd = forward_kinematics_for_msra._some_variables()
    xyz = forward_kinematics_for_msra.fkl_torch(expmap, parent, offset, rotInd, expmapInd)
    return xyz
